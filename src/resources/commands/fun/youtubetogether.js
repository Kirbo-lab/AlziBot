	...
	async execute(interaction) {
		if (interaction.options.getSubcommand() === 'create') {
			...
			const embed = new MessageEmbed()
				...
				.addFields(
					{ name: 'What it is', value: `YouTube Together is a new API that I found, and decided to implement to ${bot.application.profile.name}. YouTube Together allows you to watch YouTube together with friends in a voice channel, all completely for free.` },
