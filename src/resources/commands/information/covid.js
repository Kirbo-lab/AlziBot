    ...
    async execute(interaction) {
        ...
        if (interaction.options.getSubcommand() === 'worldwide') {
            ...
            const worldwideEmbed = new MessageEmbed()
                ...
                .setFooter(`Fetched from ${bot.api.covid}all.`);
            ...
            const apiContinent = await fetch(`${bot.api.covid}continents/${continent}`).then(res => res.json());
            ...
            const continentEmbed = new MessageEmbed()
                ...
                .setFooter(`Fetched from ${bot.api.covid}continents/${continent}.`);
            ...
            const apiCountry = await fetch(`${bot.api.covid}countries/${country}`).then(res => res.json());
            ...
            const countryEmbed = new MessageEmbed()
                ...
                .setFooter(`Fetched from ${bot.api.covid}countries/${country}.`);
